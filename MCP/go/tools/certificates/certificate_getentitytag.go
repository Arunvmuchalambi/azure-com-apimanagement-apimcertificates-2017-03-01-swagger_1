...
func Certificate_getentitytagHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCertificate_getentitytagTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("head_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_certificates_certificateId",
		mcp.WithDescription("Gets the entity state (Etag) version of the certificate specified by its identifier."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Certificate_getentitytagHandler(cfg),
	}
}
