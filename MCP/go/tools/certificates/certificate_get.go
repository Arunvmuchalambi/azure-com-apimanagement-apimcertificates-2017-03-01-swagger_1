...
func CreateCertificate_getTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_certificates_certificateId",
		mcp.WithDescription("Gets the details of the certificate specified by its identifier."),
